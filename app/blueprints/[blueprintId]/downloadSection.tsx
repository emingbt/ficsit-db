...
export default function DownloadSection({ blueprintId, files, pioneerName }: { blueprintId: number, files: string[], pioneerName: string }) {
  ...
  return (
    <div className="w-full lg:w-1/3 min-h-64 sm:min-h-48 flex flex-grow flex-col sm:flex-row lg:flex-col 2xl:flex-row items-center justify-evenly font-bold sm:pb-0 xl:p-0 bg-foo">

...
export default function Loading() {
  return (
    <Main classname="bg-dark-bg flex flex-col">
      <div className="w-full h-16 flex flex-col items-center justify-center bg-main-bg mb-2 lg:mb-4">
        ...
        <div
          className="w-36 h-6 animate-pulse bg-light-bg rounded-md"
          style={{
            animationDelay: "1s",
      ...
      <section className="w-full flex-grow grid grid-cols-2 lg:grid-cols-7 gap-2 lg:gap-4">
              ...
              return (
                <div className="w-full flex flex-row items-center my-2" key={i}>
                  <div className="w-8 h-8 sm:w-12 sm:h-12 lg:w-16 lg:h-16 shrink-0 bg-light-bg rounded-sm sm:rounded-md p-1">
                    <div
                      className="w-full h-full animate-pulse bg-main-bg rounded-sm sm:rounded-md"
                      style={{
                  ...
                  <div className="w-full flex flex-col justify-center ml-2">
                    <div
                      className="w-full sm:w-1/2 h-6 animate-pulse bg-light-bg rounded-md"
                      style={{
                    ...
                    <div className="flex flex-row items-center text-xs xl:text-base mt-1">
                      <div
                        className="w-6 h-4 animate-pulse bg-light-bg rounded-md mr-1"
                        style={{
        ...
        <div className="w-full col-span-2 lg:col-span-3 lg:order-2 bg-main-bg">
          <div className="w-full h-[calc(100%-20px)] lg:min-h-[24rem] flex flex-col justify-around p-4">
